...
var_dump($_SESSION['datei']);
var_dump($_SESSION['dateii']);


if(isset($_POST['submit'])){

    //CHECK SI VIDE 
    if (empty($_POST['habillage']) and empty($_POST['moving_Star']) and empty($_POST['espace_Interieur']) and empty($_POST['digital'])) 
    {
